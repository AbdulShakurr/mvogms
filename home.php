...
<body>
    ...
    <!--       <div class="card card-outlin card-dark shadow rounded-0">
                    ...
                    <div class="product-img-holder position-relative">
                        ...
                        <div class="card-body border-top border-gray">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="col-auto px-0 flex-shrink-1 flex-grow-1 text-center"><p class="m-0 pl-3"><small class="text-primary"><?= format_num($row['price']) ?></small></p></div>
                            </div>
            ...
            <div class="text-center">
                <a href="./?page=products" class="btn btn-large  rounded-pill col-lg-3 col-md-5 col-sm-12" style="background-color: green;">Explore More Products</a>
            </div>
        </div>
    </div>   

...
<!-- Navbar -->
      ...
      <nav class="w-100 px-2 py-2 position-fixed top-0 bg-light text-dark" id="login-nav">
        <div class="d-flex justify-content-between w-100">
          ...
          <div>
            ...
            <?php else: ?>
              <a href="./login.php" class="mx-2 text-dark text-decoration-none font-weight-bold">Client Login</a>  
              <a href="./vendor" class="mx-2 text-dark text-decoration-none font-weight-bold">Vendor Login</a>  
              <a href="./admin" class="mx-2 text-dark text-decoration-none font-weight-bold">Admin Login</a>
            <?php endif; ?>
          </div>
        </div>
      </nav>
      <nav class="main-header navbar navbar-expand-md navbar-light border-0 text-sm bg-success text-light shadow" id='top-Nav'>
        ...
        <div class="container">
          ...
          <div class=" collapse navbar-collapse order-3" id="navbarCollapse">
            ...
            <ul class="navbar-nav ">
              ...
              <li class="nav-item">
                <a href="./?page=products" class="nav-link text-light <?= isset($page) && $page =='products' ? "active" : "" ?>">Products</a>
              </li>
              <li class="nav-item">
                <a href="./?page=about" class="nav-link text-light <?= isset($page) && $page =='about' ? "active" : "" ?>">About Us</a>
              </li>
              <?php if($_settings->userdata('id') > 0 && $_settings->userdata('login_type') == 3): ?>
              <li class="nav-item">
                <?php 
